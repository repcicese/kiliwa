...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" background="img/im002.gif" bgcolor="#FFFFFF">
  <tr>
    ...
    <td align="left" valign="bottom"><h3 style="position:relative; left:-35px;">vinculos </h3></td>
...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td valign="top" bgcolor="#FFFFFF"><form id="articulos" name="articulos" method="post" action="?p=procesar-vinculos-eliminar">
        ...
        [if siPadre -s padre]<tr>
          ...
          <th nowrap="nowrap"><a href="?p=vinculos&amp;c=[padre] ">regresar...</a>&nbsp;&nbsp;&nbsp;</th>
          <td>&#8230;</td>
          <td nowrap="nowrap">&#8230;</td>
          <td nowrap="nowrap">&#8230;</td>
        </tr>[endif siPadre]
        [each forCarpetas carpetai carpetas]<tr>
          ...
          <th><a href="?p=vinculos&c=[carpetai.id]"><img src="img/icono-dir.gif" width="16" height="13" border="0" /></a></th>
          <th nowrap="nowrap"><a href="?p=vinculos&c=[carpetai.id]">[carpetai.nombre]</a>&nbsp;&nbsp;&nbsp;</th>
        ...
        <tr>
          ...
          <th><a href="?p=vinculos-ver&amp;id=[articulo.id]"><img src="img/icono-htm.gif" width="16" height="18" border="0" /></a></th>
          <th nowrap="nowrap"><a href="[articulo.url]" target="_blank" title="[articulo.url]">[articulo.urlc]</a> <a href=".?p=vinculos-editar&id=[articulo.id]" style="color:#ABABAB">(editar)</a>&nbsp;&nbsp;&nbsp;</th>
        ...
        <table border="0" align="center" cellpadding="3" cellspacing="0" class="tabla3">
          <tr>
            <th><br />
              ...
              <input name="Button" type="button" class="boton" value="Agregar V&iacute;nculo" style="width: 120px" onclick="window.location = '?p=vinculos-subir&c=[carpeta]'" />
            [endif siCrear_recursos]
            [if siBorrar_recursos -s borrar_recursos]
            <input name="Submit222" type="button" class="boton" value="Eliminar Seleccionados" style="font-weight: normal; width: 145px" onclick="if ((confirm('¿Desea eliminar los archivos y carpetas seleccionadas?\n(las carpetas sólo se eliminarán si se encuentran vacías)')) && (validarEliminar())) articulos.submit()" />
