...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td valign="top" bgcolor="#FFFFFF"><form action="?p=procesar-software-subir" method="post" enctype="multipart/form-data" name="articulo" id="articulo" onsubmit="return validarSoftware()">
      ...
      <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="tabla5">
       <tr>
        ...
        <tr>
          ...
          <td class="tablaInstrucciones">T&iacute;tulo/descripci&oacute;n del Software </td>
        </tr>
      ...
      <table border="0" align="center" cellpadding="3" cellspacing="0" class="tabla3">
          <tr>
            ...
            <input name="Submit" id="submit_data" type="submit" class="boton" value="Subir Software" style="width: 115px" onclick="obtenerUptime()" disabled/>[endif siCrear_recursos]
            <input name="Submit2" type="button" class="boton" value="Cancelar" style="font-weight: normal; width: 70px" onclick="window.location = '?p=software&c=[carpeta]'" /></th>
          </tr>
        </table>
    </form>
    </td>
