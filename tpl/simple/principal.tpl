...
<body onload="MM_preloadImages('img/b01on.gif','img/b02on.gif','img/b03on.gif','img/b04on.gif','img/b05on.gif','img/b06on.gif','img/b07on.gif','img/b09on.gif','img/b08on.gif','img/b10on.gif','img/b11on.gif');loadContent('combobox-perfiles-principal');">
...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" background="img/im002.gif" bgcolor="#FFFFFF">
  <tr>
    ...
    <td align="left" valign="bottom"><h3 style="position:relative; left:-35px;">bienvenido </h3></td>
...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
      ...
      <table width="95%" border="0" align="center" cellpadding="12" cellspacing="0" class="fondoImagen">
              <tr>
                <td>Bienvenido a <strong>Kiliwa Repositorio Compartido desarrollado en CICESE</strong>,
                  ...
                  se encuentran las noticias y archivos que han sido publicados
                  ultimamente. Env&iacute;e sus dudas, sugerencias o comentarios
                  a <a href="mailto:alex.bdiego@gmail.com" class="liga">alex.bdiego@gmail.coma></td>
              </tr>
        </table>
        <br />
	...
	[if siMensaje -s mensaje]
		...
		[if siCrear_usuarios -s crear_usuarios]
		[if siNue -s nuevos]
        <table width="92%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td><h3>nuevos usuarios </h3></td>
            <td align="right" valign="bottom">&nbsp;</td>
          </tr>
        </table>
        <table width="95" border="0" align="center" cellpadding="0" cellspacing="0" class="tabla3">
          
          
          <tr>
            <th width="33%"><strong>&nbsp;&nbsp;&nbsp;nombre</strong></th>
            <th width="33%"><strong>&nbsp;&nbsp;&nbsp;correo</strong></th>
            <th width="34%"><strong>&nbsp;&nbsp;&nbsp;opciones</strong></br>
            &nbsp;&nbsp;<select name="lista_perfiles" id="lista_perfiles">
                <option value="0" selected="selected">SELECCIONE UN PERFIL DE USUARIO</option>
              </select>
            </th>
          </tr>
		  [each forNue nuevo nuevos]
          <tr>
            <td>[nuevo.nombre]</td>
            <td><a href="mailto:[nuevo.correo]">[nuevo.correo] </a></td>
            <td>
	      	<img id="imagen_combobox_perfiles" style="display:none" src="img/loading.gif" width="16" height="16" border="0"/>
            <input type="button" name="Button" value="Autorizar" onclick='if(validarPerfilUsuario()==true){ window.location="?p=usuario-autorizar&id=[nuevo.id]&idp="+document.getElementById("lista_perfiles").value; }' style="font-size:7pt; width:68px" />
            <input type="button" name="Submit2" value="Negar" onclick="window.location = '?p=usuario-negar&id=[nuevo.id]'" style="font-size:7pt; width:52px" />
            &nbsp;</td>
          </tr>
		  [endeach forNue]
          <tr>
		...
		[endif siCrear_usuarios]
		
        <table width="92%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td><h3>archivos </h3></td>
          </tr>
        </table>
        <table border="0" align="center" cellpadding="0" cellspacing="0" class="tabla3">
          <tr>
            ...
            <th style="padding-left: 10px"><strong>descripci&oacute;n</strong></th>
            <th style="padding-left: 10px"><strong>secci&oacute;n</strong></th>
            <th width="115" style="padding-left: 10px"><strong>fecha</strong></th>
          </tr>
          [each forArchs archivo archivos]
  <tr>
    <th><a href="?p=[archivo.pagina]-ver&amp;id=[archivo.id]"><img src="img/icono-[archivo.icono].gif" border="0" /></a></th>
    <th nowrap="nowrap"><a href="?p=[archivo.pagina]-ver&amp;id=[archivo.id]">[archivo.nombre]</a>&nbsp;&nbsp;&nbsp;</th>
    <td>[archivo.titulo] </td>
    <td><a href="?p=[archivo.pagina]">[archivo.seccion] </a></td>
    <td nowrap="nowrap">[archivo.fecha] </td>
  </tr>
          [endeach forArchs]
        </table>
        ...
        <table width="92%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td><h3>noticias </h3></td>
            <td align="right" valign="bottom">&nbsp;</td>
          </tr>
        </table>
        <table width="95%" border="0" align="center" cellpadding="8" cellspacing="0" class="tabla7">
          [each forNot noticiai noticias]<tr>
            <td><strong>[noticiai.titulo]</strong><br />
                <div class="noticia">[noticiai.texto] <span class="style1" align="right" style="font-size: 7pt">([noticiai.fecha])</span></div></td>
          </tr>[endeach forNot]
        </table>
        <table border="0" align="center" cellpadding="3" cellspacing="0" class="tabla3">
          <tr>
