...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" background="img/im002.gif" bgcolor="#FFFFFF">
  <tr>
    ...
    <td align="left" valign="bottom"><h3 style="position:relative; left:-35px;">software</h3></td>
...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td valign="top" bgcolor="#FFFFFF"><form id="articulos" name="articulos" method="post" action="?p=procesar-software-eliminar">
        ...
        [if siPadre -s padre]<tr>
          ...
          <th nowrap="nowrap"><a href="?p=software&amp;c=[padre] ">regresar...</a>&nbsp;&nbsp;&nbsp;</th>
          <td>&#8230;</td>
          <td nowrap="nowrap">&#8230;</td>
          <td nowrap="nowrap">&#8230;</td>
        </tr>[endif siPadre]
        [each forCarpetas carpetai carpetas]<tr>
          ...
          <th><a href="?p=software&c=[carpetai.id]"><img src="img/icono-dir.gif" width="16" height="13" border="0" /></a></th>
          <th nowrap="nowrap"><a href="?p=software&c=[carpetai.id]">[carpetai.nombre]</a>&nbsp;&nbsp;&nbsp;</th>
        ...
        <tr>
          ...
          <th><a href="?p=software-ver&amp;id=[articulo.id]"><img src="img/icono-[articulo.icono].gif" border="0" /></a></th>
          <th nowrap="nowrap"><a href="?p=software-ver&amp;id=[articulo.id]">[articulo.nombre]</a>&nbsp;&nbsp;&nbsp;</th>
        ...
        <table border="0" align="center" cellpadding="3" cellspacing="0" class="tabla3">
          <tr>
            ...
            [if siCrear_recursos -s crear_recursos]
              <input name="Button" type="button" class="boton" value="Subir Software" style="width: 115px" onclick="window.location = '?p=software-subir&c=[carpeta]'" />
