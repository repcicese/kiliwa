...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td valign="top" bgcolor="#FFFFFF"><form action="?p=procesar-tutoriales-editar" method="post" enctype="multipart/form-data" name="articulo" id="articulo" onsubmit="return validarSoftwareEdicion()">
      ...
      <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="tabla5">
        <tr>
          <th width="70"><input name="id" type="hidden" id="id" value="[aid]" />
            Archivo </th>
        ...
        <tr>
          ...
          <td class="tablaInstrucciones">T&iacute;tulo/descripci&oacute;n del Tutorial </td>
        </tr>
        
        <tr>
          <th>URL</th>
          <td valign="top"><input name="url" type="text" id="url"[if siUrl -s url] value="[url]"[endif siUrl] size="40" /></td>
          <td class="tablaInstrucciones">Direcci&oacute;n Web</td>
        </tr>
        <tr>
      ...
      <table border="0" align="center" cellpadding="3" cellspacing="0" class="tabla3">
          <tr>
            <th><br />
            [if siCrear_recursos -s crear_recursos]<input name="Submit" type="submit" class="boton" value="Guardar Archivo" style="width: 120px" />[endif siCrear_recursos]
            <input name="Submit2" type="button" class="boton" value="Cancelar" style="font-weight: normal; width: 70px" onclick="window.location = '?p=tutoriales&c=[carpeta]'" /></th>
          </tr>
        </table>
    </form>
    </td>
