...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td valign="top" bgcolor="#FFFFFF"><form id="form1" name="form1" method="post" action="?p=procesar-noticias-agregar">
      <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="tabla4">
        <tr>
          <th width="60">T&iacute;tulo </th>
          <td><input name="titulo" type="text" id="titulo" size="70" /></td>
        </tr>
        <tr>
          <th>Contenido </th>
          <td><p>
            <textarea name="contenido" cols="70" rows="15" id="contenido"></textarea>
          </p></td>
        </tr>
        <tr>
          <th>Etiquetas</th>
          <td valign="top">
            ...
            <textarea name="etiquetas" id="etiquetas" class="txtDropTarget ui-droppable" cols="70" rows="3"></textarea>    
      ...
      <table border="0" align="center" cellpadding="3" cellspacing="0" class="tabla3">
          <tr>
            <th><br />
            [if siCrear_recursos -s crear_recursos]<input name="Submit" type="submit" class="boton" value="Agregar Noticia" style="width: 115px" />[endif siCrear_recursos]
            <input name="Submit2" type="button" class="boton" value="Cancelar" style="font-weight: normal; width: 70px" onclick="window.location = '?p=noticias'" /></th>
          </tr>
        </table>
    </form>
    </td>
