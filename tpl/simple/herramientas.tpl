...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" background="img/im002.gif" bgcolor="#FFFFFF">
  <tr>
    ...
    <td align="left" valign="bottom"><h3 style="position:relative; left:-35px;">herramientas </h3></td>
  ...
  <tr>
    ...
    <td valign="top" bgcolor="#FFFFFF"><form id="articulos" name="articulos" method="post" action="?p=procesar-articulos-eliminar">
      <table width="95%" border="0" align="center" cellpadding="12" cellspacing="0" class="fondoImagen">
              <tr>
                <td>A continuaci&oacute;n se muestran algunas herramientas para exportar
                  las referencias de los articulos que actualmente se encuentran
                  en el repositorio. Para las referencias en LaTeX, se encuentra
                  disponible un archivo de estilo que corresponde con el estilo
                  de referencias utilizado en CICESE, el cual puede descargar
                  en el siguiente v&iacute;nculo: <a href="?p=herramientas-bst" class="ligaBold">cicese.bst</a></td>
              </tr>
        </table>
        <br />
        <table width="92%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td><h3>exportar a LaTeX  </h3></td>
          </tr>
        </table>
		<table width="95%" align="center" cellpadding="0" cellspacing="0" border="0"><tr><td><div class="areaCodigo">[latex]</div></td></tr></table>
        <table border="0" align="center" cellpadding="3" cellspacing="0" class="tabla3">
          <tr>
            <th><br />
              <input name="Submit2" type="button" class="boton" value="Descargar .BIB" onclick="window.location = '?p=herramientas-latex'" style="font-weight: normal; width: 100px" />
            <br />
            <br /></th>
          </tr>
        </table>
        <table width="92%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td><h3>exportar a HTML  </h3></td>
            <td align="right" valign="bottom">&nbsp;</td>
          </tr>
        </table>
        <table width="95%" align="center" cellpadding="0" cellspacing="0" border="0"><tr><td><div class="areaHTML">[html]</div></td></tr></table>
        <table border="0" align="center" cellpadding="3" cellspacing="0" class="tabla3">
          <tr>
            <th><br />
            <input name="Submit22" type="button" class="boton" value="Descargar .HTML" onclick="window.location = '?p=herramientas-html'" style="font-weight: normal; width: 115px" /></th>
          </tr>
        </table>
        </form>
    </td>
