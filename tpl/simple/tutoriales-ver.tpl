  ...
  <tr>
    ...
    <td>[resumen]</td>
      ...
      <table border="0" align="center" cellpadding="3" cellspacing="0" class="tabla3">
          <tr>
            <th><br />
            <input name="b1" type="button" class="boton" value="Descargar" style="width: 85px" onclick="window.location = '?p=tutoriales-bajar&id=[id]'" />
            [if siActualizar_recursos -s actualizar_recursos]<input name="b2" type="button" class="boton" value="Editar" style="font-weight: normal; width: 50px" onclick="window.location = '?p=tutoriales-editar&id=[aid]'" />[endif siActualizar_recursos]
            <input name="b3" type="button" class="boton" value="Regresar" style="font-weight: normal; width: 70px" onclick="window.location = '?p=tutoriales&c=[carpeta]'" /></th>
          </tr>
        </table>
    </form>
    </td>
