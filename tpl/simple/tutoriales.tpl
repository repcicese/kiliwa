...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" background="img/im002.gif" bgcolor="#FFFFFF">
  <tr>
    ...
    <td align="left" valign="bottom"><h3 style="position:relative; left:-35px;">tutoriales </h3></td>
...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td valign="top" bgcolor="#FFFFFF"><form id="articulos" name="articulos" method="post" action="?p=procesar-tutoriales-eliminar">
        ...
        [if siPadre -s padre]<tr>
          ...
          <th nowrap="nowrap"><a href="?p=tutoriales&amp;c=[padre] ">regresar...</a>&nbsp;&nbsp;&nbsp;</th>
          <td>&#8230;</td>
          <td nowrap="nowrap">&#8230;</td>
          <td nowrap="nowrap">&#8230;</td>
        </tr>[endif siPadre]
        [each forCarpetas carpetai carpetas]<tr>
          ...
          <th><a href="?p=tutoriales&c=[carpetai.id]"><img src="img/icono-dir.gif" width="16" height="13" border="0" /></a></th>
          <th nowrap="nowrap"><a href="?p=tutoriales&c=[carpetai.id]">[carpetai.nombre]</a>&nbsp;&nbsp;&nbsp;</th>
		...
		[each forArticulos articulo software]
        <tr>
          <th><input type="checkbox" name="a[articulo.id]" value="1" /></th>
          <th><a href="?p=tutoriales-ver&amp;id=[articulo.id]"><img src="img/icono-[articulo.icono].gif" border="0" /></a></th>
          <th nowrap="nowrap"><a href="?p=tutoriales-ver&amp;id=[articulo.id]">[articulo.nombre]</a>&nbsp;&nbsp;&nbsp;</th>
        ...
        <table border="0" align="center" cellpadding="3" cellspacing="0" class="tabla3">
          <tr>
            ...
            <input name="Button" type="button" class="boton" value="Subir Tutorial" style="width: 105px" onclick="window.location = '?p=tutoriales-subir&c=[carpeta]'" />
            [endif siCrear_recursos]
            <!-- <input name="Submit2" type="button" class="boton" value="Nueva Carpeta" onclick="window.location = '?p=tutoriales-carpeta&c=[carpeta]'" style="font-weight: normal; width: 105px" /> -->
            <!-- <input name="Submit22" type="button" class="boton" value="Editar Carpeta" onclick="window.location = '?p=tutoriales-editar-carpeta&c=[carpeta]'" style="font-weight: normal; width: 105px"[if siPadre carpeta == 0] disabled[endif siPadre] /> -->
            [if siBorrar_recursos -s borrar_recursos]<input name="Submit222" type="button" class="boton" value="Eliminar Seleccionados" style="font-weight: normal; width: 145px" onclick="if ((confirm('¿Desea eliminar los archivos y carpetas seleccionadas?\n(las carpetas sólo se eliminarán si se encuentran vacías)')) && (validarEliminar())) articulos.submit()" />[endif siBorrar_recursos]
