...
<body onload="MM_preloadImages('img/b01on.gif','img/b02on.gif','img/b03on.gif','img/b04on.gif','img/b05on.gif','img/b06on.gif','img/b07on.gif','img/b09on.gif','img/b08on.gif','img/b10on.gif','img/b11on.gif');loadInfo('mostrar_etiquetas');">
...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" background="img/im002.gif" bgcolor="#FFFFFF">
  <tr>
    ...
    <td align="left" valign="bottom"><h3 style="position:relative; left:-35px;">editar
        art&iacute;culo </h3></td>
...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td valign="top" bgcolor="#FFFFFF"><form action="?p=procesar-articulos-editar" method="post" enctype="multipart/form-data" name="articulo" id="articulo" onsubmit="return validarArticuloEdicion()">
      ...
      <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="tabla5">
        <tr>
          <th width="120"><input name="id" type="hidden" id="id" value="[aid]" />
            Archivo </th>
          <td valign="top"><input name="archivo" type="file" id="archivo" size="28" /></td>
          <td class="tablaInstrucciones">Si no desea reemplazar el archivo actual,
            deje el campo vac&iacute;o. Cualquier formato es aceptado</td>
        </tr>
        <tr>
          <th>Autores</th>
          <td valign="top"><input name="autores" type="text" id="autores" value="[autores]" size="40" /><br />
			<span class="tablaNota">Ejemplo: <strong>Shuoqi Li; Ying Lin; Sang H. Son</strong></span></td>
          <td class="tablaInstrucciones">Separe cada autor con punto y coma</td>
        </tr>
        <tr>
          <th>T&iacute;tulo</th>
          <td valign="top"><input name="titulo" type="text" id="titulo" value="[tituloa]" size="40" /></td>
          <td class="tablaInstrucciones">T&iacute;tulo del art&iacute;culo en su idioma original</td>
        </tr>
        <tr>
          <th>A&ntilde;o</th>
          <td valign="top"><input name="anno" type="text" id="anno" value="[anno]" size="5" maxlength="9" /></td>
          <td class="tablaInstrucciones">A&ntilde;o de publicaci&oacute;n del
            art&iacute;culo. </td>
        </tr>
        <tr>
          <th>Revista / Conferencia </th>
          <td valign="top"><input name="revista" type="text" id="revista"[if siRev -s revista] value="[revista]"[endif siRev] size="40" /></td>
          <td class="tablaInstrucciones">Nombre de la revista, conferencia o
            libro en el que aparece el art&iacute;culo (opcional) </td>
        </tr>
        <tr>
          <th>Lugar y Fecha </th>
          <td valign="top"><input name="lugar" type="text" id="lugar"[if siLug -s lugar] value="[lugar]"[endif siLug] size="40" /><br />
            <span class="tablaNota">Ejemplo: <strong>New York, USA, Febrero 2004</strong></span></td>
          <td class="tablaInstrucciones">En caso de tratarse de una conferencia, escriba el lugar y la fecha
            donde se efectu&oacute; la misma (opcional)<br /></td>
        </tr>
        <tr>
          <th>Vol&uacute;men</th>
          <td valign="top"><input name="volumen" type="text" id="volumen"[if siVol -s volumen] value="[volumen]"[endif siVol] size="5" /></td>
          <td class="tablaInstrucciones">Vol&uacute;men del art&iacute;culo (opcional)</td>
        </tr>
        <tr>
          <th>N&uacute;mero</th>
          <td valign="top"><input name="numero" type="text" id="numero"[if siNum -s numero] value="[numero]"[endif siNum] size="5" /></td>
          <td class="tablaInstrucciones">N&uacute;mero del art&iacute;culo (opcional)</td>
        </tr>
        <tr>
          <th>P&aacute;ginas</th>
          <td valign="top"><input name="paginas" type="text" id="paginas"[if siPag -s paginas] value="[paginas]"[endif siPag] size="10" />
            <br />
            <span class="tablaNota">Ejemplo: <strong>120-145 </strong></span></td>
          <td class="tablaInstrucciones">P&aacute;ginas que comprenden el art&iacute;culo,
            separe con gui&oacute;n (opcional) </td>
        </tr>
        <tr>
          <th>URL</th>
          <td valign="top"><input name="url" type="text" id="url"[if siUrl -s url] value="[url]"[endif siUrl] size="40" /></td>
          <td class="tablaInstrucciones">Direcci&oacute;n Web donde se localiza
            el art&iacute;culo
            (opcional como &uacute;ltimo recurso) </td>
        </tr>
        <tr>
          <th>Res&uacute;men</th>
          <td valign="top"><textarea name="resumen" cols="40" rows="6" id="resumen">[if siRes -s resumen][resumen][endif siRes] </textarea></td>
          <td class="tablaInstrucciones">&nbsp;</td>
        </tr>
        <tr>
          <th>Etiquetas</th>
          <td valign="top">

            <textarea name="etiquetas" id="etiquetas" class="txtDropTarget ui-droppable" cols="50" rows="3">[etiquetas]</textarea>    
            <div id="draggable_etiquetas">
            </div>

          </td>
          <td class="tablaInstrucciones">
            <p>Arrastre las etiquetas al recuadro para seleccionar los temas con los que se relaciona el articulo, el articulo podr&aacute; ser visto en todas las categor&iacute;as que se seleccionen.</p>
          </td>
        </tr>
      </table>
      <table border="0" align="center" cellpadding="3" cellspacing="0" class="tabla3">
          <tr>
            ...
            <input name="Submit" type="submit" class="boton" value="Guardar Art&iacute;culo" style="width: 125px" />
            [endif siActualizar_recursos]
            <input name="Submit2" type="button" class="boton" value="Cancelar" style="font-weight: normal; width: 70px" onclick="window.location = '?p=articulos&c=[carpeta]'" /></th>
          </tr>
        </table>
    </form>
    </td>
