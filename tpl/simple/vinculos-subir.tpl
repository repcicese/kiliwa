...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" background="img/im002.gif" bgcolor="#FFFFFF">
  <tr>
    ...
    <td align="left" valign="bottom"><h3 style="position:relative; left:-35px;">agregar
        v&iacute;nculo</h3></td>
...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td valign="top" bgcolor="#FFFFFF"><form action="?p=procesar-vinculos-subir" method="post" enctype="multipart/form-data" name="articulo" id="articulo" onsubmit="return validarVinculo()">
      ...
      <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="tabla5">
        ...
        <tr>
          <th width="70">URL</th>
          <td width="280" valign="top"><input name="url" type="text" id="url" size="40" /></td>
          <td class="tablaInstrucciones">Direcci&oacute;n Web</td>
        </tr>
        <tr>
          <th>Descripci&oacute;n</th>
          <td valign="top"><textarea name="descripcion" cols="40" rows="6" id="descripcion"></textarea></td>
      ...
      <table border="0" align="center" cellpadding="3" cellspacing="0" class="tabla3">
          <tr>
            <th><br />
            [if siCrear_recursos -s crear_recursos]<input name="Submit" type="submit" class="boton" value="Agregar V&iacute;nculo" style="width: 120px" />[endif siCrear_recursos]
            ...
            <input name="carpeta" type="hidden" id="carpeta" value="[cid]" /></th>
          </tr>
        </table>
    </form>
    </td>
