...
<body onload="MM_preloadImages('img/b01on.gif','img/b02on.gif','img/b03on.gif','img/b04on.gif','img/b05on.gif','img/b06on.gif','img/b07on.gif','img/b09on.gif','img/b08on.gif','img/b10on.gif','img/b11on.gif');loadContent('combobox-perfiles');">
...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" background="img/im002.gif" bgcolor="#FFFFFF">
  <tr>
    ...
    <td align="left" valign="bottom"><h3 style="position:relative; left:-35px;">perfiles de usuario </h3></td>
...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
	...
	<table width="95%" align="center" cellpadding="0" cellspacing="0" border="0"><tr><td><form id="perfiles" name="perfiles" method="post" action="#">
	  <table border="0" cellpadding="0" cellspacing="0" class="tabla2">
	    <tr>
	      <th width="160">Perfiles</th>
	      <td width="895"><div align="left"><select name="lista_perfiles" id="lista_perfiles" onchange="onChangeOptions('preparar-formulario-lista-perfiles',this.value)">
	        <option value="0" selected="selected">Seleccione una opción</option>
	        <option value="-1">-- Registrar perfil nuevo --</option>
	        </select>
	      <img id="imagen_combobox_perfiles" style="display:none" src="img/loading.gif" width="16" height="16" border="0"/></div></td>
	      </tr>
	    <tr height="0">
	      <th height="0"><div id="nombre_perfiles" style="display:none">Nombre del perfil</div></th>
	      <td><div id="textfield_perfiles" style="display:none">
	    ...
	    <tr height="0">
	      ...
	      <td>
          [if siConfiguracion_perfil -s configuracion_perfil]
          <input id="button_perfil_guardar" type="button" name="button_perfil_guardar" value="Guardar" style="display:none" onclick="services('guardar-perfil',0,0)"/>
          [endif siConfiguracion_perfil]
          </td>
	      </tr>
	    </table>
        <div id="perfiles_trabajo_tabla" align="center" style="display:none">
    	</div>
        </form>
