...
<script type="text/JavaScript" src="lib/subirarchivos.js"></script>
...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" background="img/im002.gif" bgcolor="#FFFFFF">
  <tr>
    ...
    <td align="left" valign="bottom"><h3 style="position:relative; left:-35px;">subir
        tutorial </h3></td>
...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td valign="top" bgcolor="#FFFFFF"><form action="?p=procesar-tutoriales-subir" method="post" enctype="multipart/form-data" name="articulo" id="articulo" onsubmit="return validarSoftware()">
      ...
      <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="tabla5">
        <tr>
          <th width="120"><input name="carpeta" type="hidden" id="carpeta" value="[carpeta]" />
            Archivo </th>
          <td valign="top">
            <div id="queue"></div>
            <input id="file_upload" name="file_upload" type="file" multiple="true">
          </td>
          <td class="tablaInstrucciones">Cualquier formato es aceptado</td>
        </tr>
        <tr>
        
        <tr>
          <th>Descripci&oacute;n</th>
          <td valign="top"><input name="titulo" type="text" id="titulo" size="40" /></td>
          <td class="tablaInstrucciones">T&iacute;tulo/descripci&oacute;n del Tutorial </td>
        </tr>
        
        <tr>
          <th>URL</th>
          <td valign="top"><input name="url" type="text" id="url" size="40" /></td>
          <td class="tablaInstrucciones">Direcci&oacute;n Web</td>
        </tr>
        <tr>
          <th>Notas</th>
          <td valign="top"><textarea name="resumen" cols="40" rows="6" id="resumen"></textarea></td>
        ...
        <tr>
          ...
          <td valign="top">
            ...
            <textarea name="etiquetas" id="etiquetas" class="txtDropTarget ui-droppable" cols="50" rows="3"></textarea>    
      ...
      <table border="0" align="center" cellpadding="3" cellspacing="0" class="tabla3">
          <tr>
            ...
            <input name="uptime" id="uptime" type="hidden" value=""/>
            <input name="Submit" id="submit_data" type="submit" class="boton" value="Subir Tutorial" style="width: 115px" onclick="obtenerUptime()" disabled/>[endif siCrear_recursos]
